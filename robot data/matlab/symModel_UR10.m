...
Theta_i_j{2,1} = [Theta_i_j{2,1}(1);Theta_i_j{2,1}(3);Theta_i_j{2,1}(4)];
Theta_i_j{2,3} = [Theta_i_j{2,3}(2);Theta_i_j{2,3}(3);Theta_i_j{2,3}(6)];
Theta_i_j{3,1} = [Theta_i_j{3,1}(1);Theta_i_j{3,1}(2);Theta_i_j{3,1}(4)];
Theta_i_j{3,3} = [Theta_i_j{3,3}(1);Theta_i_j{3,3}(3);Theta_i_j{3,3}(5)];
Theta_i_j{4,1} = [Theta_i_j{4,1}(1);Theta_i_j{4,1}(4)];
Theta_i_j{4,3} = [Theta_i_j{4,3}(3)];
Theta_i_j{5,1} = [Theta_i_j{5,1}(1);Theta_i_j{5,1}(4)];
Theta_i_j{5,3} = [Theta_i_j{5,3}(3)];
Theta_i_j{5,1} = [Theta_i_j{6,1}(1);Theta_i_j{6,1}(4)];
Theta_i_j{6,3} = [Theta_i_j{6,3}(3)];
